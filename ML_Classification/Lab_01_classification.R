...
setwd("C:/Users/Utilizador/repos/Formacao_cientista_de_dados/big_data_analytics_R_microsoft_azure_machine_learning/Modulo_11/Classificacao")
getwd()
...
# Visualizando as váriaveis (resumo)
str(dados$diagnosis)
